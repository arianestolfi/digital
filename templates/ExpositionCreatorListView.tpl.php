<?php
	$this->assign('title','DIGITAL | ExpositionCreators');
	$this->assign('nav','expositioncreators');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/expositioncreators.js").wait(function(){
...
<h1>
	<i class="icon-th-list"></i> ExpositionCreators
	...
	<script type="text/template" id="expositionCreatorCollectionTemplate">
...
-->
	...
	<script type="text/template" id="expositionCreatorModelTemplate">
		...
		<form id="deleteExpositionCreatorButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deleteExpositionCreatorButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete ExpositionCreator</button>
						<span id="confirmDeleteExpositionCreatorContainer" class="hide">
							<button id="cancelDeleteExpositionCreatorButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteExpositionCreatorButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal hide fade" id="expositionCreatorDetailDialog">
		<div class="modal-header">
			<a class="close" data-dismiss="modal">&times;</a>
			<h3>
				<i class="icon-edit"></i> Edit ExpositionCreator
				<span id="modelLoader" class="loader progress progress-striped active"><span class="bar"></span></span>
			</h3>
		</div>
		<div class="modal-body">
			<div id="modelAlert"></div>
			<div id="expositionCreatorModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="saveExpositionCreatorButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="expositionCreatorCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newExpositionCreatorButton" class="btn btn-primary">Add ExpositionCreator</button>
	</p>
