...
/**
 * This is an example Reporter based on the FondLevel object.  The reporter object
 ...
 * @version 1.0
 */
class FondLevelReporter extends Reporter
{
	...
	*/
	static function GetCustomQuery($criteria)
	{
		$sql = "select
			...
			,`fond_level`.`idfondlevel` as Idfondlevel
