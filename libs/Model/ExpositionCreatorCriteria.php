...
require_once("DAO/ExpositionCreatorCriteriaDAO.php");

/**
 * The ExpositionCreatorCriteria class extends ExpositionCreatorDAOCriteria and is used
 ...
 * @version 1.0
 */
class ExpositionCreatorCriteria extends ExpositionCreatorCriteriaDAO
{
