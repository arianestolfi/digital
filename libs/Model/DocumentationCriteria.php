...
require_once("DAO/DocumentationCriteriaDAO.php");

/**
 * The DocumentationCriteria class extends DocumentationDAOCriteria and is used
 ...
 * @version 1.0
 */
class DocumentationCriteria extends DocumentationCriteriaDAO
{
