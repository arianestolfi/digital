...
require_once("DAO/StorageCriteriaDAO.php");

/**
 * The StorageCriteria class extends StorageDAOCriteria and is used
 ...
 * @version 1.0
 */
class StorageCriteria extends StorageCriteriaDAO
{
