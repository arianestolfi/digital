...
require_once("DAO/ItemdescriptionCriteriaDAO.php");

/**
 * The ItemdescriptionCriteria class extends ItemdescriptionDAOCriteria and is used
 ...
 * @version 1.0
 */
class ItemdescriptionCriteria extends ItemdescriptionCriteriaDAO
{
