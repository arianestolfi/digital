...
require_once("DAO/TranscriptionCriteriaDAO.php");

/**
 * The TranscriptionCriteria class extends TranscriptionDAOCriteria and is used
 ...
 * @version 1.0
 */
class TranscriptionCriteria extends TranscriptionCriteriaDAO
{
