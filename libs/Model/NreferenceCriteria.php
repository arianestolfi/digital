...
require_once("DAO/NreferenceCriteriaDAO.php");

/**
 * The NreferenceCriteria class extends NreferenceDAOCriteria and is used
 ...
 * @version 1.0
 */
class NreferenceCriteria extends NreferenceCriteriaDAO
{
