...
require_once("DAO/ItemcreatorCriteriaDAO.php");

/**
 * The ItemcreatorCriteria class extends ItemcreatorDAOCriteria and is used
 ...
 * @version 1.0
 */
class ItemcreatorCriteria extends ItemcreatorCriteriaDAO
{
