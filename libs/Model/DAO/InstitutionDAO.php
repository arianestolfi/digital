...
require_once("InstitutionMap.php");

/**
 * InstitutionDAO provides object-oriented access to the institution table.  This
 ...
 * @version 1.0
 */
class InstitutionDAO extends Phreezable
{
	/** @var int */
	...
	/**
	 * Returns a dataset of Contact objects with matching Institution
	 * @param Criteria
	 * @return DataSet
	 */
	public function GetContacts($criteria = null)
	{
		return $this->_phreezer->GetOneToMany($this, "fk_contact_institution1", $criteria);
	}
	...
	{
		return $this->_phreezer->GetOneToMany($this, "fk_institutionmedia_institution", $criteria);
	}

	/**
	 * Returns a dataset of Item objects with matching Institution
	 * @param Criteria
	 * @return DataSet
	 */
	public function GetItems($criteria = null)
	{
		return $this->_phreezer->GetOneToMany($this, "fk_item_institution1", $criteria);
	}
	...
	/**
	 * Returns a dataset of Nhistory objects with matching Institution
	 * @param Criteria
	 * @return DataSet
	 */
	public function GetNhistorys($criteria = null)
	{
		return $this->_phreezer->GetOneToMany($this, "FK_19r8lwpjqv2j4hcqpjkwb1nsc", $criteria);
	}
	...
	/**
	 * Returns a dataset of PlaceLocation objects with matching Institution
	 * @param Criteria
	 * @return DataSet
	 */
	public function GetPlaceLocations($criteria = null)
	{
		return $this->_phreezer->GetOneToMany($this, "fk_placelocation_institution", $criteria);
	}
	...
	{
		return $this->_phreezer->GetOneToMany($this, "fk_reference_institution", $criteria);
	}
