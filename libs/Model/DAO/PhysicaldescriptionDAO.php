...
require_once("PhysicaldescriptionMap.php");

/**
 * PhysicaldescriptionDAO provides object-oriented access to the physicaldescription table.  This
 ...
 * @version 1.0
 */
class PhysicaldescriptionDAO extends Phreezable
{
	/** @var int */
	public $Id;
