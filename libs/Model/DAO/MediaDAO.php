...
require_once("MediaMap.php");

/**
 * MediaDAO provides object-oriented access to the media table.  This
 ...
 * @version 1.0
 */
class MediaDAO extends Phreezable
{
	/** @var int */
	public $Idmedia;
	...
	{
		return $this->_phreezer->GetOneToMany($this, "FK_documentationmedia_media", $criteria);
	}

	/**
	 * Returns a dataset of HistoryMedia objects with matching MediasIdmedia
	 * @param Criteria
	 * @return DataSet
	 */
	public function GetSHistoryMedias($criteria = null)
	{
		return $this->_phreezer->GetOneToMany($this, "fk_historymedia_media", $criteria);
	}
	...
	{
		return $this->_phreezer->GetOneToMany($this, "fk_institutionmedia_media", $criteria);
	}
	...
	{
		return $this->_phreezer->GetOneToMany($this, "fk_itemmedia_media", $criteria);
	}
	...
	{
		return $this->_phreezer->GetOneToMany($this, "fk_refmedia_media", $criteria);
	}
	...
	/**
	 * Returns a dataset of Transcription objects with matching Idmedia
	 * @param Criteria
	 * @return DataSet
	 */
	public function GetIdTranscriptions($criteria = null)
	{
		return $this->_phreezer->GetOneToMany($this, "fk_transcription_media1", $criteria);
	}
