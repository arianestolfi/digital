...
class RoleCriteriaDAO extends Criteria
{
	...
	public $Idrole_Equals;
	public $Idrole_NotEquals;
	public $Idrole_IsLike;
	public $Idrole_IsNotLike;
	public $Idrole_BeginsWith;
	public $Idrole_EndsWith;
	public $Idrole_GreaterThan;
	public $Idrole_GreaterThanOrEqual;
	public $Idrole_LessThan;
	public $Idrole_LessThanOrEqual;
	public $Idrole_In;
	public $Idrole_IsNotEmpty;
	public $Idrole_IsEmpty;
	public $Idrole_BitwiseOr;
	public $Idrole_BitwiseAnd;
	public $Name_Equals;
