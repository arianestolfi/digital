...
require_once("DAO/CreatorHistoryCriteriaDAO.php");

/**
 * The CreatorHistoryCriteria class extends CreatorHistoryDAOCriteria and is used
 ...
 * @version 1.0
 */
class CreatorHistoryCriteria extends CreatorHistoryCriteriaDAO
{
