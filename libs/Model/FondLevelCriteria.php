...
require_once("DAO/FondLevelCriteriaDAO.php");

/**
 * The FondLevelCriteria class extends FondLevelDAOCriteria and is used
 ...
 * @version 1.0
 */
class FondLevelCriteria extends FondLevelCriteriaDAO
{
