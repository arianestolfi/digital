...
require_once("DAO/InfobjectfondCriteriaDAO.php");

/**
 * The InfobjectfondCriteria class extends InfobjectfondDAOCriteria and is used
 ...
 * @version 1.0
 */
class InfobjectfondCriteria extends InfobjectfondCriteriaDAO
{
