...
require_once("DAO/InstitutionMediaCriteriaDAO.php");

/**
 * The InstitutionMediaCriteria class extends InstitutionMediaDAOCriteria and is used
 ...
 * @version 1.0
 */
class InstitutionMediaCriteria extends InstitutionMediaCriteriaDAO
{
