...
require_once("DAO/ReferenceCriteriaDAO.php");

/**
 * The ReferenceCriteria class extends ReferenceDAOCriteria and is used
 ...
 * @version 1.0
 */
class ReferenceCriteria extends ReferenceCriteriaDAO
{
