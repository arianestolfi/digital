...
require_once("DAO/CreatorCriteriaDAO.php");

/**
 * The CreatorCriteria class extends CreatorDAOCriteria and is used
 ...
 * @version 1.0
 */
class CreatorCriteria extends CreatorCriteriaDAO
{
