...
require_once("DAO/DocumentationMediaCriteriaDAO.php");

/**
 * The DocumentationMediaCriteria class extends DocumentationMediaDAOCriteria and is used
 ...
 * @version 1.0
 */
class DocumentationMediaCriteria extends DocumentationMediaCriteriaDAO
{
