...
require_once("DAO/HistoryCriteriaDAO.php");

/**
 * The HistoryCriteria class extends HistoryDAOCriteria and is used
 ...
 * @version 1.0
 */
class HistoryCriteria extends HistoryCriteriaDAO
{
