...
require_once("DAO/TimezonesCriteriaDAO.php");

/**
 * The TimezonesCriteria class extends TimezonesDAOCriteria and is used
 ...
 * @version 1.0
 */
class TimezonesCriteria extends TimezonesCriteriaDAO
{
