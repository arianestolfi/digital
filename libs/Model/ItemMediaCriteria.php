...
require_once("DAO/ItemMediaCriteriaDAO.php");

/**
 * The ItemMediaCriteria class extends ItemMediaDAOCriteria and is used
 ...
 * @version 1.0
 */
class ItemMediaCriteria extends ItemMediaCriteriaDAO
{
