...
require_once("DAO/CreatorReferenceCriteriaDAO.php");

/**
 * The CreatorReferenceCriteria class extends CreatorReferenceDAOCriteria and is used
 ...
 * @version 1.0
 */
class CreatorReferenceCriteria extends CreatorReferenceCriteriaDAO
{
