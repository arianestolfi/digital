...
require_once("DAO/NhistoryCriteriaDAO.php");

/**
 * The NhistoryCriteria class extends NhistoryDAOCriteria and is used
 ...
 * @version 1.0
 */
class NhistoryCriteria extends NhistoryCriteriaDAO
{
