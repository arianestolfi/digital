...
require_once("DAO/CreatornameCriteriaDAO.php");

/**
 * The CreatornameCriteria class extends CreatornameDAOCriteria and is used
 ...
 * @version 1.0
 */
class CreatornameCriteria extends CreatornameCriteriaDAO
{
