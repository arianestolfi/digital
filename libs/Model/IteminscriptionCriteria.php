...
require_once("DAO/IteminscriptionCriteriaDAO.php");

/**
 * The IteminscriptionCriteria class extends IteminscriptionDAOCriteria and is used
 ...
 * @version 1.0
 */
class IteminscriptionCriteria extends IteminscriptionCriteriaDAO
{
