...
require_once("DAO/CreatorAwardHonourCriteriaDAO.php");

/**
 * The CreatorAwardHonourCriteria class extends CreatorAwardHonourDAOCriteria and is used
 ...
 * @version 1.0
 */
class CreatorAwardHonourCriteria extends CreatorAwardHonourCriteriaDAO
{
