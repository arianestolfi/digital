...
require_once("DAO/ExpoitemCriteriaDAO.php");

/**
 * The ExpoitemCriteria class extends ExpoitemDAOCriteria and is used
 ...
 * @version 1.0
 */
class ExpoitemCriteria extends ExpoitemCriteriaDAO
{
