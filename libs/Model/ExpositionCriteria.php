...
require_once("DAO/ExpositionCriteriaDAO.php");

/**
 * The ExpositionCriteria class extends ExpositionDAOCriteria and is used
 ...
 * @version 1.0
 */
class ExpositionCriteria extends ExpositionCriteriaDAO
{
