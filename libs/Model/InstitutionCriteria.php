...
require_once("DAO/InstitutionCriteriaDAO.php");

/**
 * The InstitutionCriteria class extends InstitutionDAOCriteria and is used
 ...
 * @version 1.0
 */
class InstitutionCriteria extends InstitutionCriteriaDAO
{
