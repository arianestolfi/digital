...
require_once("DAO/NcontactCriteriaDAO.php");

/**
 * The NcontactCriteria class extends NcontactDAOCriteria and is used
 ...
 * @version 1.0
 */
class NcontactCriteria extends NcontactCriteriaDAO
{
