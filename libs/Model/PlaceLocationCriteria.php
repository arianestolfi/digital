...
require_once("DAO/PlaceLocationCriteriaDAO.php");

/**
 * The PlaceLocationCriteria class extends PlaceLocationDAOCriteria and is used
 ...
 * @version 1.0
 */
class PlaceLocationCriteria extends PlaceLocationCriteriaDAO
{
