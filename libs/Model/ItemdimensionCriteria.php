...
require_once("DAO/ItemdimensionCriteriaDAO.php");

/**
 * The ItemdimensionCriteria class extends ItemdimensionDAOCriteria and is used
 ...
 * @version 1.0
 */
class ItemdimensionCriteria extends ItemdimensionCriteriaDAO
{
