...
require_once("DAO/CountryCriteriaDAO.php");

/**
 * The CountryCriteria class extends CountryDAOCriteria and is used
 ...
 * @version 1.0
 */
class CountryCriteria extends CountryCriteriaDAO
{
