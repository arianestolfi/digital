...
require_once("DAO/StorageMediaCriteriaDAO.php");

/**
 * The StorageMediaCriteria class extends StorageMediaDAOCriteria and is used
 ...
 * @version 1.0
 */
class StorageMediaCriteria extends StorageMediaCriteriaDAO
{
