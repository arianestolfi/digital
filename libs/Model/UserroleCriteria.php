...
require_once("DAO/UserroleCriteriaDAO.php");

/**
 * The UserroleCriteria class extends UserroleDAOCriteria and is used
 ...
 * @version 1.0
 */
class UserroleCriteria extends UserroleCriteriaDAO
{
