...
require_once("DAO/AddressCriteriaDAO.php");

/**
 * The AddressCriteria class extends AddressDAOCriteria and is used
 ...
 * @version 1.0
 */
class AddressCriteria extends AddressCriteriaDAO
{
