...
require_once("DAO/ExpositionHistoryCriteriaDAO.php");

/**
 * The ExpositionHistoryCriteria class extends ExpositionHistoryDAOCriteria and is used
 ...
 * @version 1.0
 */
class ExpositionHistoryCriteria extends ExpositionHistoryCriteriaDAO
{
