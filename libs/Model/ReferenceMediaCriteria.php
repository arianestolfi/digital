...
require_once("DAO/ReferenceMediaCriteriaDAO.php");

/**
 * The ReferenceMediaCriteria class extends ReferenceMediaDAOCriteria and is used
 ...
 * @version 1.0
 */
class ReferenceMediaCriteria extends ReferenceMediaCriteriaDAO
{
