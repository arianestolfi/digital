...
require_once("DAO/CreatorContactCriteriaDAO.php");

/**
 * The CreatorContactCriteria class extends CreatorContactDAOCriteria and is used
 ...
 * @version 1.0
 */
class CreatorContactCriteria extends CreatorContactCriteriaDAO
{
