...
require_once("DAO/DimensionCriteriaDAO.php");

/**
 * The DimensionCriteria class extends DimensionDAOCriteria and is used
 ...
 * @version 1.0
 */
class DimensionCriteria extends DimensionCriteriaDAO
{
