...
require_once("DAO/HistoryMediaCriteriaDAO.php");

/**
 * The HistoryMediaCriteria class extends HistoryMediaDAOCriteria and is used
 ...
 * @version 1.0
 */
class HistoryMediaCriteria extends HistoryMediaCriteriaDAO
{
