...
class RoleController extends AppBaseController
{
	...
	public function Create()
	{
		try
		{
			...
			// $role->Idrole = $this->SafeGetVal($json, 'idrole');

			$role->Name = $this->SafeGetVal($json, 'name');
			$role->Institution = $this->SafeGetVal($json, 'institution');
	...
	public function Update()
	{
		try
		{
			...
			// $role->Idrole = $this->SafeGetVal($json, 'idrole', $role->Idrole);

			$role->Name = $this->SafeGetVal($json, 'name', $role->Name);
			$role->Institution = $this->SafeGetVal($json, 'institution', $role->Institution);
